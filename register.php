            ...
            <div class="login-form">
                <div class="sign-up-html">
                    <div class="group">
                        ...
                        <spaan style="color: rgb(141, 14, 14);margin-left:17px;font-size:20x;font-weight: 350;"><?php echo $username_err?></spaan>
                    </div>
                    <div class="group">
                        <label for="pass" class="label">Password</label>
                        <input type="password" class="form-control" name ="password" id="inputPassword4" placeholder="Password">
                        <spaan style="color: rgb(141, 14, 14); margin-left:17px;font-size20px;font-weight: 500;"><?php echo $password_err?></spaan>
                    </div>
                    <div class="group">
                    ...
                    <div class="group">
                        ...
                        <input type="tel" class="form-control" name ="phoneno." id="inputPassword4" placeholder="Phone No.">
                    </div>
                    <div class="group">
